	...
	return (
		<Flex flexDirection={'column'}>
			<Flex gap={3} my={2} onClick={(e) => e.preventDefault()}>
				<svg aria-label='Like' color={liked ? "rgb(237, 73, 86)" : ""} fill={liked ? "rgb(237, 73, 86)" : "transparent"} height='19' role='img' viewBox='0 0 24 22' width='20' onClick={handleLikeAndUnlike}>
			...
			>
				...
				<ModalFooter>
					<Button isLoading={isReplying} onClick={handleReply} colorScheme='blue' size={'sm'} mr={3}>
						Reply
					</Button>
				</ModalFooter>
				</ModalContent>
